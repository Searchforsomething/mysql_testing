...
def test_add_index(db_connection):
    ...
    target_value1, target_value2, target_value3, target_value4 = 'ifnyc', 'rucvu', 'votlq', 'vhqik'
    ...
    for i in range(tests_amount):
        ...
        query = (f"SELECT {column1}, {column2}, {column3}, {column4} FROM random_strings_big WHERE "
